    ...
    <div id="content">
        <div class="panel">
            <div class="panel-body">
                <div class="col-md-12">
                    <h3 class="animated fadeInLeft">管理员信息编辑页面</h3>
        ...
        <%
            ...
            {
        %>
        <form action="管理员信息编辑管理.jsp" method="post">
                            ...
                            <div class="panel-body" style="padding-bottom:30px;">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input id="button2" type="text" name="username" class="form-control" value="<%=rs.getString("username")%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input id="button3" type="text" name="userpassword" class="form-control" value="<%=rs.getString("password")%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-right" style="display: none;">用户名</label>
                                        ...
                                        <div class="col-sm-3">
                                            <input id="button4" type="text" name="usersex" class="form-control" value="<%=rs.getString("sex")%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-right" style="display: none;">用户名</label>
                                        ...
                                        <div class="col-sm-3">
                                            <input id="button6" type="text" name="userph" class="form-control" value="<%=rs.getString("ph")%>">
                                        </div>
                                    </div>
