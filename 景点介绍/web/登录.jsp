...
<body>
    <!-- 大背景 -->
    <div class="back" style="background:url(img/登录界面/3j.jpg);width: 100%;height: 100%;margin: 0">
        <!-- logo -->
        <div class="logo" style="margin-top: 125px"></div>
        <!-- 内容 -->
        <div class="content">
            <!-- input -->
            <form action="登录管理.jsp" method="post" name="loginForm">
                ...
                <div id="light" class="white_content" style="position: absolute">
                    <a href = "javascript:void(0)" onclick = "closeDialog()" style="position: relative;top: 40px">
                        <img src="关闭.png" style="width: 5%;height: 5%;">
                    </a>
