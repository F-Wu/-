...
<div class="container-fluid mimin-wrapper">
    ...
    <form action="景点发布管理.jsp" method="post" enctype="multipart/form-data">
        <div id="content">
            <div class="panel">
                            ...
                            <div class="panel-body" style="padding-bottom:30px;">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-1 control-label text-right" style="font-size: 18px">景点主题</label>
                                        <div class="col-sm-3">
                                            <input type="text" id="newsitem" name="Title" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-right" style="display: none;">用户名</label>
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" id="newsauthor" name="Author" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-right" style="display: none;">用户名</label>
                                        ...
                                        <label class="col-sm-1 control-label text-right" style="font-size: 18px">主题英文</label>
                                        <div class="col-sm-3">
                                            <input type="text" id="newsauthor1" name="E" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-right" style="display: none;">用户名</label>
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" id="newsdate" name="TimeS" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-right" style="display: none;">用户名</label>
                                        ...
                                        <label class="col-sm-1 control-label text-right" style="font-size: 18px">景点介绍</label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-1 control-label text-right" style="font-size: 18px">收藏数</label>
                                        <div class="col-sm-3">
                                            <input id="button5" type="text" name="Collection" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-right" style="display: none;">用户名</label>
                                        ...
                                        <label class="col-sm-1 control-label text-right" style="font-size: 18px">点赞数</label>
                                        <div class="col-sm-3">
                                            <input id="button7" type="text" name="Give" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-right" style="display: none;">用户名</label>
                                        ...
                                        <label class="col-sm-1 control-label text-right" style="font-size: 18px">评论数</label>
                                        <div class="col-sm-3">
                                            <input id="button8" type="text" name="Discuss" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
