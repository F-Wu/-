    ...
    <div id="content">
        <div class="panel">
            <div class="panel-body">
                <div class="col-md-12">
                    <h3 class="animated fadeInLeft">景点列表</h3>
                    <p class="animated fadeInDown"> 业务 <span class="fa-angle-right fa"></span>  景点列表 </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel form-element-padding">
                    ...
                    <div class="panel">
                        ...
                        <div style="width: 55%;margin: 20px auto;font-size: medium;font-style: normal;">
                            <form method="post" action="景点列表.jsp">
                                按主题查找：<input type="text" name="txtSearchName">
                                按作者查找：<input type="text" name="txtSearchph">
                                按ID查找：<input type="text" name="id">
                                <input type="submit" value="搜索" class="submit btn btn-danger" style="margin-left: 40%;margin-top: 20px">
                            </form>
                        </div>
                        <div class="panel-body">
                                        ...
                                        <div class="col-sm-12">
                                            <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" style="width: 60px;">主题</th>
                                                    <th class="sorting" style="width: 60px;">作者</th>
                                                    <th class="sorting"  style="width: 60px;">日期</th>
                                                    <th class="sorting"  style="width: 60px;">点赞</th>
                                                    <th class="sorting"  style="width: 60px;">收藏</th>
                                                    <th class="sorting"  style="width: 60px;">评论</th>
                                                ...
                                                <%
                                                    ...
                                                    if (null!=searchName && ! "".equals(searchName))
                                                        str1 ="and title like '%"+searchName+"%'";
                                                    ...
                                                    String sql="select* from scenic where '1==1'"+str1+str2+str3;
                                                    ResultSet rs=conn.query(sql);
                                                    while(rs.next())
                                                    {//循环开始
                                                %>
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1"><%=rs.getString("id")%></td>
                                                    <td><%=rs.getString("title")%></td>
                                                    <td><%=rs.getString("author")%></td>
                                                    <td><%=rs.getString("timeS")%></td>
                                                    <td><%=rs.getString("Collection")%></td>
                                                    <td><%=rs.getString("give")%></td>
                                                    <td><%=rs.getString("discuss")%></td>
                                                    <td><a href="景点列表编辑.jsp?ID=<%=rs.getInt("id")%>">编辑 </a > | <a href="景点信息删除.jsp?ID=<%=rs.getInt("id")%>"> 删除 </a> </td>
                                                </tr>
                                                <%
                                                    }
                                                    conn.close();
